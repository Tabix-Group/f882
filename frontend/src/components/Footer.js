...
const Footer = () => {
    const [showTop, setShowTop] = (0, react_1.useState)(false);
    ...
    return (<footer className="w-full py-10 bg-neutral-950 text-gray-300 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div>
          ...
          <ul className="text-sm text-gray-400 space-y-2">
            <li>
              Email: <a href="mailto:info@f88.com" className="text-blue-400 hover:underline">info@f88.com</a>
            </li>
            <li>
              Soporte: <a href="/customer-service" className="text-blue-400 hover:underline">Atención al Socio</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <a aria-label="YouTube" href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
            ...
            <a aria-label="Facebook" href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
            ...
            <a aria-label="Instagram" href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
        ...
        <div className="col-span-1 md:col-span-3 text-center text-xs text-gray-500 mt-6">
          &copy; {new Date().getFullYear()} F88. Todos los derechos reservados.
        </div>
      </div>

      {showTop && (<button onClick={scrollToTop} aria-label="Volver arriba" className="fixed right-6 bottom-6 z-50 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400">
          ↑
        </button>)}
    </footer>);
};
