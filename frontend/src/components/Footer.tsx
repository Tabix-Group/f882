      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div>
          ...
          <ul className="text-sm text-gray-400 space-y-2">
            <li>
              Email: <a href="mailto:fortitude.f88@gmail.com" className="text-blue-400 hover:underline">fortitude.f88@gmail.com</a>
            </li>
            <li>
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a aria-label="YouTube" href="https://www.youtube.com/@f88oficial" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
            ...
            <a aria-label="Facebook" href="https://www.facebook.com/profile.php?id=61581790711128" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
            ...
            <a aria-label="Instagram" href="https://www.instagram.com/f88oficial/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
            ...
            <a aria-label="TikTok" href="https://www.tiktok.com/@f88oficial" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
            ...
            <a aria-label="X (Twitter)" href="https://x.com/f88oficial" target="_blank" rel="noopener noreferrer" className="p-2 rounded-md hover:bg-neutral-900/60 transition-colors">
