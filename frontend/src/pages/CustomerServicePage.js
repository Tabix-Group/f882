          ...
          <section className="md:col-span-2 bg-white/5 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/10">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <article className="p-6 rounded-xl bg-gradient-to-r from-white/3 to-white/2 border border-white/6 hover:scale-102 transition-transform shadow-sm">
                ...
                <button onClick={() => { const el = document.querySelector('#chat-widget-button'); el === null || el === void 0 ? void 0 : el.click(); }} className="mt-3 text-sm text-blue-300 hover:underline">Abrir asistente</button>
              </article>
            </div>
          ...
          <aside className="md:col-span-1">
            <div className="bg-gradient-to-br from-white/4 to-white/3 p-6 rounded-2xl shadow-lg border border-white/8 text-center">
              ...
              <div className="mt-6 flex flex-col items-center gap-3">
                ...
                <button onClick={() => { const el = document.querySelector('#chat-widget-button'); el === null || el === void 0 ? void 0 : el.click(); }} className="mt-2 inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-semibold shadow-md">
                  Abrir Jordan
                </button>
                <button onClick={() => { window.dispatchEvent(new Event('chat:minimize')); }} className="mt-2 inline-flex items-center gap-2 bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-full font-semibold shadow-sm">
                  Minimizar Jordan
                </button>
