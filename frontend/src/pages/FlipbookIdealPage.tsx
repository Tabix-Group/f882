...
const FlipbookIdealPage: React.FC = () => {
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-purple-500/20 border border-purple-500/30 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-purple-300 font-semibold">NIVEL IDEAL</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            El movimiento es vida. Cada ejercicio consciente nos recuerda que estamos hechos para movernos.
          </p>
        </div>
        ...
        <div className="space-y-16">
          ...
          <section className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
            ...
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              El movimiento es vida. Cada ejercicio consciente nos recuerda que estamos hechos para movernos. La actividad física no es solo un hábito saludable: <strong className="text-blue-300">ES LA BASE ESCENCIAL PARA DESARROLLAR TODAS LAS DEMAS FORTALEZAS DEL PROGRAMA FORTITUDE 88</strong>. Cuando mueves tu cuerpo, despiertas tu mente, gestionas tus emociones, desarrollas tu carácter y tu voluntad.
            </p>
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-2xl p-6">
              <h4 className="text-2xl font-bold text-purple-300 mb-4">Nivel IDEAL — Rinde de por Vida</h4>
              <p className="text-gray-200">
                Este mensaje es para ti, que actualmente cuentas con un nivel adecuado de actividad física y ahora puedes dar un paso más hacia generar un hábito de por vida. F88 te ayudará al seguimiento. No hay juicios, solo un punto de partida claro: <strong>consolidar y mantener hábitos de por vida, y porque no, elevar tu nivel actual</strong>.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
            ...
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              Imagina que hoy es el primer día del resto de tu vida activa. Y puedes prescindir de gimnasios y planes complejos. Solo tú, tu cuerpo y una decisión: liberarte de las excusas que te impidan ejercitar de por vida.
            </p>
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              Las barreras son mentales: "No tengo más tiempo", "No tengo el lugar apropiado", "Lo que hago es suficiente", "Ya intenté otras cosas". Son ladrillos en una muralla invisible que te separa de tu mejor versión.
            </p>
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-6 mb-6">
              <p className="text-yellow-200 font-semibold">
                Sin excusas en el camino, recuerda: no necesitas nada especial ni complicado, para generar e incorporar hábitos de por vida.
              </p>
            </div>
          ...
          <section className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
            ...
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              "Que calzas y que vistes" a diario, es un gesto simple que marca una gran diferencia entre el movimiento y el estancamiento. Calzar tenis (zapatillas) y vestir ropa cómoda no es solo cuestión de estilo; es una señal a tu cerebro de que estás listo para activarte en cualquier horario, lugar y edad.
            </p>
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-6 mb-6">
              ...
              <p className="text-green-200 font-semibold mt-4">
                Este hábito envía un mensaje claro: "Estoy preparado para moverme en cualquier momento, lugar y edad". Es un compromiso silencioso con tu fortaleza física.
              </p>
            </div>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-2xl p-6">
              <h5 className="text-blue-300 font-bold mb-2">Actividad:</h5>
          ...
          <section className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-6 mb-6">
              <p className="text-red-200 font-semibold mb-2">Pregunta: ¿Qué separa a quienes se mantienen fuertes de por vida de quienes abandonan en algún punto del camino?</p>
              <p className="text-red-300 font-bold">Respuesta: Mantenerse en la mejor forma de por vida requiere completar retos que te inspiren y te saquen de la comodidad y rutina actual.</p>
            </div>
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              Recuerda: lo importante aquí es el hábito de por vida, no la mayor intensidad. Por ello la importancia de la <strong className="text-blue-300">FRECUENCIA y la CONSTANCIA</strong>.
            </p>
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-2xl p-6 mb-6">
              <p className="text-purple-200">
                Tu "Misogi" — desafíos personal y significativo — es que complementes tu actividad física actual, completando y reportando a diario las actividades y tiempos del plan desde el día 1 al 88.
              </p>
            </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-200">"Caminata intensa (ritmo rápido) o trote". Se completa el tiempo diario SIN pausas.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
          ...
          <section className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
            ...
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              Hace 88 días iniciaste la primera etapa de un nuevo camino, elegiste generar habitos de por vida. Quizás empezaste con la pregunta de si podrías mantenerte constante y cumplir tu Misogi. Y sin darte cuenta, día tras día, fuiste construyendo tus nuevos hábitos. Hoy miras hacia atrás y sonríes con la satisfacción de haber cumplido tu Misogi, y haber incorporado tus nuevos hábitos saludables.
            </p>
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-2xl p-6 mb-6">
              ...
              <p className="text-gray-200">
                El verdadero triunfo no es solo completar la primera etapa del programa F88, sino haber convertido la actividad física y sus "compañeros inseparables"; en parte de tu nueva identidad de por vida. Cuando ves y sientes los beneficios, tu mente deja de buscar excusas y empieza a ver nuevas oportunidades. La fortaleza física y la constancia son más que fuerza o resistencia; son confianza y orgullo por lo que eres capaz de lograr. Cada hábito que adoptaste —ejercitar a diario, nutrirte con calidad, dormir adecuadamente, contemplar en diversas formas — son piezas claves de tu nueva identidad.
              </p>
            </div>
            <p className="text-lg text-gray-200 leading-relaxed mb-6">
              No te detengas aquí. Haz de la actividad física y sus "compañeros inseparables" sean hábitos irrenunciables. Permite que otros reconozcan en ti no solo el estado físico actual, sino la actitud y fortaleza que ahora te definen.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-2xl p-6">
              <h5 className="text-blue-300 font-bold mb-2">Actividad:</h5>
...
export default FlipbookIdealPage;